...
\begin{center}
  ...
  \newline
\end{center}
Per calcolare il costo computazionale si e' andati a contare le valutazioni funzionali, eseguite da ogni algoritmo,
...
il grafico ottenuto.
\\
\textbf{Osservazione:} si e' voluto creare un unico plot contenente tutti e 3 i risultati,
per mostrare che questi ultimi sono tutti pressoche' uguali.
...
\begin{center}
  \begin{longtable}{ |p{2.8cm}|p{2.8cm}|p{2.8cm}| }
    ...
    \hline
  \end{longtable}
  \includegraphics*[scale=0.80]{./esercizi/imgs/graficonewtonj.pdf}
\end{center}
